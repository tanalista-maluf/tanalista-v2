      ...
      <header className="border-b border-white/[0.06] px-4 py-3 sticky top-0 z-10" style={{ background: 'var(--background)' }}>
        <div className="max-w-6xl mx-auto flex items-center gap-3">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <a
              href="/home"
              className="text-xs text-white/40 hover:text-white border border-white/10 hover:border-white/20 px-3 py-1.5 rounded-lg transition-colors whitespace-nowrap"
            >
              ← Sair
            </a>
          </div>
